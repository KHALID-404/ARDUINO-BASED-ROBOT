...
else if(bt_ir_data ==10){mode=2; Speed=230;} //Auto Obstacle Avoiding Command
...
long IRremote_data(){
     if(results.value==0xE51A7F80){IR_data=1;}  
else if(results.value==0xFA057F80){IR_data=2;} 
else if(results.value==0XFE017F80){IR_data=3;} 
else if(results.value==0xFC037F80){IR_data=4;} 
else if(results.value==0xFD027F80 || results.value==0xFFA857){IR_data=5;} 
else if(results.value==0xED127F80){IR_data=8;} 
else if(results.value==0xFB047F80){IR_data=9;} 
else if(results.value==0xE11E7F80){IR_data=10;} 
return IR_data;
}
...
digitalWrite(in2, LOW);  //Right Motor backw ord Pin 
